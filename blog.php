			...
			<div class="row">
					...
					<div class="blog__single">
						<div class="blog__single--box">
							...
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">Tips for creating high-quality images
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							...
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">Designing immersive experiences using
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							...
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">Exploring the different image formats
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-2-1.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">A Journey through UI Excellence,
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-2-2.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">Showcasing my UI Design Projects,
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-2-3.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">An In-Depth UI Design Showcase
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-4-2.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">A Showcase of My Development Projects,
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-three-2.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">Unveiling the Magic Behind Web
				...
				<div class="col-lg-4 col-md-6">
					<div class="blog__single">
						<div class="blog__single--box">
							<a href="blog-details.php" class="blog-img">
								<img src="assets/img/blog/blog-4-1.php" alt="blog-1">
								<span class="link-btn"><i class="fa-sharp fa-light fa-arrow-right-long"></i></span>
							</a>
							<div class="blog__single--meta">
								<a href="blog-details.php" class="blog--title">EA Journey through My Web Development
