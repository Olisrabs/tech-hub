...
<body class="page-template">
	...
	<!-- not found -->
	<section class="error pt-100 pb-100">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="error__wrapper">
						<div class="error__icon--animate">
							<img src="assets/img/icon/cloud.php" alt="error">
							<img src="assets/img/icon/ball.php" alt="error">
							<img src="assets/img/icon/ball.php" alt="error">
							<img src="assets/img/icon/four-round-start.php" alt="error">
							<img src="assets/img/icon/four-round-start.php" alt="error">
							<img src="assets/img/icon/all-star.php" alt="error">

						</div>
						<div class="error__text">
							<h1>404</h1>
							<h2>This page is outside of the universe</h2>
							<p>The Page were looking for could not be found</p>
						</div>
						<div class="error__btn">
							<a href="index-2.php" class="main-btn">Back to Home</a>
						</div>
						<div class="error__helpus">
							<p>if you think this is error! Please let us know.
