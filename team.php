			...
			<div class="row">
					...
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-1.png" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Md. Asifur Rahman</a>
										<span>CEO</span>
									</div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-3.png" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Zent Ekizie</a>
										<span>Marketer</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-4.png" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Israt Popy</a>
										<span>Developer</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-member-4.png" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Ayat Rahman</a>
										<span>Developer</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-5.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Rony Khan</a>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-6.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Natasha</a>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-7.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Pamela Paul</a>
										<span>QA Tester</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-8.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Maliha</a>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-9.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Muntaha</a>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-10.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Sayma Said</a>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-11.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Mysha Khan</a>
										<span>Intern</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
				...
				<div class="col-xl-3 col-lg-6 col-md-6">
					<div class="team__single">
						<div class="team__single--box">
							<div class="team__single--wrap">
								<img class="img-fluid" src="assets/img/team/team-12.php" alt="">
								<div class="team-meta">
									<div class="team-meta-info">
										<a href="team-details.php">Adam Khan</a>
										<span>Intern</span>
									</div>
									<div class="team-meta-social">
										<div class="icon"><i class="fa-solid fa-plus"></i></div>
